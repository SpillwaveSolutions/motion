...
## States
- **Closed**: Default.
- **Open**: Filter shrinks the list as the query grows. `/ai` → Ask AI first; `/tab` → Table only; `/mer` → Mermaid only.
...
- [ ] Seven commands, Ask AI first: Ask AI, Table, Mermaid, Dataset, Query, AI Diagram, AI Image.
- [ ] `/ai` highlights Ask AI; `/tab` inserts Table; `/mer` still inserts Mermaid.
