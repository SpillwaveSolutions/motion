...
- task: [[Ticket-01KYFZ6RBJC07FEQ0FT0KQ302M]] Fix web/dev storage mock so Dataset/Query are testable outside Tauri — WebStorage.readFile only returns real content for three hardcoded demo paths; any other
