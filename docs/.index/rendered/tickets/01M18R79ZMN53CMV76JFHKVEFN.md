...
- [[Ticket-01M19Z6Z5DJ54227R1WYVVX2GF]] Insert Table nests when the caret is already in a table — Insert Table (toolbar or /tab) while the caret is already in a table can nest a table, because cells allow block+. (open)
- [[Ticket-01M19Z6Z6X06VRZM95741Y2748]] DocCommands batch should resolve against the original document — DocCommands apply sequentially against the updated markdown. (open)
