...
- task: [[Ticket-01KYFZ6RBJV920SFW0MAN9MX9J]] Wire the per-note enrichment action into the UI — cliWrappers, TopicRefiner, TOCGenerator, SkillGenerator, and ContentInjector are all real,
