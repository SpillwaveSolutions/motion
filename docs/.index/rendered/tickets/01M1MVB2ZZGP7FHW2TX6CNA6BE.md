...
`01M1MVB2ZZGP7FHW2TX6CNA6BE` · epic/feature · **open**
...
- [[Ticket-01M1MVB2ZZFQX90WHGB0CA99RW]] Replace SKILL.md with a generated folder README — Synthesize keeps TOC.md. (open)
...
record source and license in a comment. (open)
- [[Ticket-01M1MVB300EAR8PX5HKEACTKP1]] Make the header drag the window — Regression against 0.6.3. (open)
- [[Ticket-01M1MVB300TGVNPJBG8GJ6KG1T]] Scale content without scaling chrome — Stop writing documentElement.style.fontSize. (open)
