...
doc_type: roadmap
truth_state: current
source_hash: 12b6888b
generated_at: 2026-08-30T07:37:24Z
---
...
### AI editor: selection, /ai, preview  ·  P1  ·  4 of 8 done  ·  → v0.6.0
...
| 01M18R79 | Tiptap tables + markdown round-trip | task | P2 | todo | — |
| 01M18R79 | Shared TS AI service: stream, per-doc session, prompt cache | task | P2 | todo | — |
...
### AI editor: selection, /ai, preview  ·  P1  ·  4 of 8 done
Three entry points, one pipeline, preview before commit. Phase 1 on the existing CLI transport.
...
graph TD
    ...
    01M18R79ZMK0DX0PE2DPWMZ60D["📦 Tiptap tables + markdown round"]
    01M18R79ZMKBXK2PGWR6911MJQ["📦 Shared TS AI service stream pe"]
